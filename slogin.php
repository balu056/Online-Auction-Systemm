			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-6">
								<a href="#" class="active" id="login-form-link">Seller Login</a>
							</div>
							<div class="col-xs-6">
								<a href="#" id="register-form-link"> Seller Register</a>
							</div>
						</div>
						<hr>
					</div>
...
if(isset($_POST['register']))
{
	...
	$insert=mysqli_query($conn,"insert into seller(name,email,address,contact,password)values('$name','$email','$address','$contact','$password')") or die(mysqli_error());
	if($insert)
	{
