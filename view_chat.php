...
<li><a href="view_chat.php" class="active">View</a></li>
...
<div class="container">
          ...
          <tr><td>ID</td><td>Bidder name</td><td>Chat</td></tr>
          <div>
		  <div>
		  <div>
		  <div>
		  <?php
		$t=mysqli_query($conn,"select * from question");
		while($j=mysqli_fetch_array($t))
		{
		$id=$j['id'];
		$bidder_name=$j['bidder_name'];
		$chat=$j['chat'];
			
echo "<tr><td>$id</td><td>$bidder_name</td><td>$chat</td></tr>";
				}
				?>
                </table>
             </div>           
